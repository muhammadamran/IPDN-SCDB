...
Highcharts.chart('chart1span1', {
	title: {
		text: 'Klasifikasi Pegawai Institut Pemerintahan Dalam Negeri Berdasarkan Usia'
	},
	subtitle: {
...
Highcharts.chart('chart1span2', {
	title: {
		text: 'Pegawai PNS & Non-PNS Institut Pemerintahan Dalam Negeri'
	},
	subtitle: {
		text: 'Sumber: scdb.ipdn.ac.id'
	},
...
Highcharts.chart('chart1span3', {
	title: {
		text: 'Pegawai PNS Institut Pemerintahan Dalam Negeri Berdasarkan Golongan'
	},
	subtitle: {
		text: 'Sumber: scdb.ipdn.ac.id'
	},
	...
	series: [{
		...
		data: [
		['Eselon I', 1220, true],
		['Eselon II', 1115, false],
		['Eselon III', 100, false],
		['Eselon IV', 150, false]
		],
		showInLegend: true
	}],
...
Highcharts.chart('chart1span4', {
	title: {
		text: 'Pegawai Non-PNS Institut Pemerintahan Dalam Negeri Berdasarkan Golongan'
	},
	subtitle: {
		text: 'Sumber: scdb.ipdn.ac.id'
	},
...
Highcharts.chart('chart1spanPensiun', {
	title: {
		text: 'Jumlah Pegawai Pensiun Berdasarkan Golongan, Range Tahun 2020-2027'
	},
	subtitle: {
		text: 'Sumber: scdb.ipdn.ac.id'
	},
	...
	series: [{
		...
		name: 'Eselon IV',
		data: [null, null, 2988, 52169, 65112, 42452, 24400, 44227]
	}, {
		name: 'Tenaga Kontrak',
