// chart 1
Highcharts.chart('chart1praja28', {
	title: {
		text: 'Jumlah Praja Angkatan 28 Institut Pemerintahan Dalam Negeri'
	},
	subtitle: {
...
Highcharts.chart('chart1praja31', {
	title: {
		text: 'Jumlah Praja Angkatan 31 Institut Pemerintahan Dalam Negeri'
	},
	subtitle: {
		text: 'Sumber: scdb.ipdn.ac.id'
	},
...
Highcharts.chart('chart1daerah1', {
	title: {
		text: 'Jumlah Praja Per-Daerah, Range Tahun 2020-2027'
	},
	subtitle: {
		text: 'Sumber: scdb.ipdn.ac.id'
	},
